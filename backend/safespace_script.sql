...
INSERT INTO listedItems(name, description, image, cat, price, seller) VALUE ("Item 5", "Item 1 Description", "https://i.ibb.co/ChYQdQC/art1.png", "Art", "0.123456789", "Yuan");
INSERT INTO listedItems(name, description, image, cat, price, seller) VALUE ("Item 6", "Item 2 Description", "https://i.ibb.co/842cvSM/art2.png", "Art", "0.123456789", "Yuan");
INSERT INTO listedItems(name, description, image, cat, price, seller) VALUE ("Item 7", "Item 3 Description", "https://i.ibb.co/YDnrM2r/art3.png", "Art", "0.123456789", "Yuan");
INSERT INTO listedItems(name, description, image, cat, price, seller) VALUE ("Item 8", "Item 4 Description", "https://i.ibb.co/Jv5f5Jd/art4.png", "Art", "0.123456789", "Yuan");
INSERT INTO listedItems(name, description, image, cat, price, seller) VALUE ("Item 9", "Item 1 Description", "https://i.ibb.co/cwyXfzy/fashion1.png", "Fashion", "0.123456789", "Tom");
INSERT INTO listedItems(name, description, image, cat, price, seller) VALUE ("Item 10", "Item 2 Description", "https://i.ibb.co/xX3MX8C/fashion2.png", "Fashion", "0.123456789", "Tom");
INSERT INTO listedItems(name, description, image, cat, price, seller) VALUE ("Item 11", "Item 3 Description", "https://i.ibb.co/RhwgT9P/fashion3.jpg", "Fashion", "0.123456789", "Tom");
INSERT INTO listedItems(name, description, image, cat, price, seller) VALUE ("Item 12", "Item 4 Description", "https://i.ibb.co/YZtrQ36/fashion4.jpg", "Fashion", "0.123456789", "Tom");
