...
INSERT INTO assetItems(name, description, image, cat, price, seller, featured) VALUE ("Item 1", "Item 1 Description", "https://i.ibb.co/r58jQcq/tech1.jpg", "Tech", "0.123456789", "Andrew", 0);
INSERT INTO assetItems(name, description, image, cat, price, seller, featured) VALUE ("Item 2", "Item 2 Description", "https://i.ibb.co/kJ23Wbb/tech2.jpg", "Tech", "0.123456789", "Andrew", 1);
INSERT INTO assetItems(name, description, image, cat, price, seller, featured) VALUE ("Item 3", "Item 3 Description", "https://i.ibb.co/zsmJY80/tech3.jpg", "Tech", "0.123456789", "Andrew", 0);
INSERT INTO assetItems(name, description, image, cat, price, seller, featured) VALUE ("Item 4", "Item 4 Description", "https://i.ibb.co/XyFRTBY/tech4.jpg", "Tech", "0.123456789", "Andrew", 1);
INSERT INTO assetItems(name, description, image, cat, price, seller, featured) VALUE ("Item 5", "Item 5 Description", "https://i.ibb.co/ChYQdQC/art1.png", "Art", "0.123456789", "Yuan", 1);
INSERT INTO assetItems(name, description, image, cat, price, seller, featured) VALUE ("Item 6", "Item 6 Description", "https://i.ibb.co/842cvSM/art2.png", "Art", "0.123456789", "Yuan", 0);
